    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnNotify1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //Channels only exist in Oreo onwards
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                    //This is if want it to be normal
//                    NotificationChannel channel = new NotificationChannel
//                            ("default", "Default Channel",
//                            NotificationManager.IMPORTANCE_DEFAULT);

                    //This is if want a notification that is heads-up
                    NotificationChannel channel = new NotificationChannel
                            ("default", "Default Channel",
                ...
                //To specify the activity to be launched when notification is being clicked
        ...
        btnNotify2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //This is to style your notification
